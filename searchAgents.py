...
def cornersHeuristic(state, problem):
    ...
    while unvisitedCorners:
        heuristic_cost, corner = min([(util.manhattanDistance(currentPos, corner), corner) for corner in unvisitedCorners]) 
...
def foodHeuristic(state, problem):
    ...
    currentPos = position
    while foodToEat:
        heuristic_cost, food = min([(util.manhattanDistance(currentPos, food), food) for food in foodToEat]) 
